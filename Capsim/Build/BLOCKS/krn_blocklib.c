...
int FQAM_64map(int  run_state,block_Pt  block_P);
...
int carroffset(int  run_state,block_Pt  block_P);
...
int convenca(int  run_state,block_Pt  block_P);
...
int cxagc(int  run_state,block_Pt  block_P);
int cxavgchannel(int  run_state,block_Pt  block_P);
...
int cxequalizezf(int  run_state,block_Pt  block_P);
...
int cxmimo_2x2_svd_fp(int  run_state,block_Pt  block_P);
int cxmimoch(int  run_state,block_Pt  block_P);
int cxmimoeqzf(int  run_state,block_Pt  block_P);
int cxmimosvd(int  run_state,block_Pt  block_P);
...
int dataField(int  run_state,block_Pt  block_P);
...
int fwfft(int  run_state,block_Pt  block_P);
...
int ifftofdm54(int  run_state,block_Pt  block_P);
int ifftofdmsvd(int  run_state,block_Pt  block_P);
...
int interlr(int  run_state,block_Pt  block_P);
...
int pilot(int  run_state,block_Pt  block_P);
...
int prcxmat(int  run_state,block_Pt  block_P);
...
int puncture(int  run_state,block_Pt  block_P);
...
int rmcpfx(int  run_state,block_Pt  block_P);
...
int scramble(int  run_state,block_Pt  block_P);
...
int stmat2x4(int  run_state,block_Pt  block_P);
int stmat4x2(int  run_state,block_Pt  block_P);
...
int synchlong(int  run_state,block_Pt  block_P);
...
{ cxagc,"cxagc","cxagc"},
{ cxavgchannel,"cxavgchannel","cxavgch"},
{ cxchmodel,"cxchmodel","cxchmod"},
{ cxconj,"cxconj","cxconj"},
{ cxcorr,"cxcorr","cxcorr"},
{ cxdelay,"cxdelay","cxdelay"},
{ cxequalizezf,"cxequalizezf","cxequal"},
{ cxgain,"cxgain","cxgain"},
{ cxmag,"cxmag","cxmag"},
{ cxmakecx,"cxmakecx","cxmakec"},
{ cxmakereal,"cxmakereal","cxmaker"},
{ cxmimo_2x2_svd,"cxmimo_2x2_svd","cxmimo_"},
{ cxmimo_2x2_svd_fp,"cxmimo_2x2_svd_fp","cxmimo_"},
{ cxmimoch,"cxmimoch","cxmimoc"},
{ cxmimoeqzf,"cxmimoeqzf","cxmimoe"},
{ cxmimosvd,"cxmimosvd","cxmimos"},
...
{ hold,"hold","hold"},
{ ifftofdm54,"ifftofdm54","ifftofd"},
{ ifftofdmsvd,"ifftofdmsvd","ifftofd"},
...
{ stmat2x4,"stmat2x4","stmat2x"},
{ stmat4x2,"stmat4x2","stmat4x"},
{ str,"str","str"},
{ strch,"strch","strch"},
{ stretch,"stretch","stretch"},
{ sum,"sum","sum"},
{ symimp,"symimp","symimp"},
{ synchlong,"synchlong","synchlo"},

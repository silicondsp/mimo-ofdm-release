...
# topology file:  svdmimo_4x2_float_wk.t
...
param int 128    npts   "Number of points ( dynamic plot window)"
param int 0    skip   "Number of points to skip"
param file evm_stream1.dat    fileName   "Title"
param file X    x_axis   "x Axis"
param file Y    y_axis   "y Axis"
param int 2    plotStyleParam   "Plot Style: 1=Line,2=Points,5=Bar Chart"
param int 0    fixed   "Fixed Bounds ( 0=none, 1=fixed)"
...
param int 128    npts   "Number of points ( dynamic plot window)"
param int 0    skip   "Number of points to skip"
param file evm_stream2.dat    fileName   "Title"
param file X    x_axis   "x Axis"
param file Y    y_axis   "y Axis"
param int 2    plotStyleParam   "Plot Style: 1=Line,2=Points,5=Bar Chart"
param int 0    fixed   "Fixed Bounds ( 0=none, 1=fixed)"
...
connect cxmimo_2x2_svd_fp0 1 stmat4x20 0  	{cxmimo_2x2_svd_fp0:NULL:NULL,stmat4x20: x1 : complex }
connect cxmimo_2x2_svd_fp0 2 stmat4x20 1  	{cxmimo_2x2_svd_fp0:NULL:NULL,stmat4x20: x2 : complex }
